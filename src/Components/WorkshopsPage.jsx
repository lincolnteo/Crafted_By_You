        ...
        <div className="grid grid-cols-2 gap-4 sm:gap-8 md:grid-cols-3">
          {workshops.map((workshop) => (
            <div
              ...
              className="group relative grid aspect-[4/3] cursor-pointer overflow-hidden rounded-[1.5rem] border border-slate-200 bg-slate-900 shadow-xl shadow-slate-200/60 transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:shadow-pink-500/20 sm:rounded-[2.2rem]"
            >
              ...
              <div className="absolute left-3 top-3 z-20 sm:left-5 sm:top-5">
                <span className="rounded-full border border-white/40 bg-white/20 px-2.5 py-1 text-[9px] font-black uppercase tracking-wider text-white shadow-sm backdrop-blur-md sm:px-4 sm:py-1.5 sm:text-xs sm:tracking-widest">
                  {workshop.tag}
                </span>
              </div>

              <div className="absolute bottom-3 left-3 right-3 z-20 flex flex-col gap-1.5 sm:bottom-6 sm:left-6 sm:right-6 sm:gap-2">
                <h3 className="line-clamp-2 text-base font-black leading-tight text-white drop-shadow-md sm:text-2xl">{workshop.title}</h3>
                <p className="line-clamp-2 text-[11px] font-medium leading-snug text-white/85 sm:text-sm sm:leading-relaxed">
                  {workshop.description}
                </p>
                <div className="mt-1 flex items-center justify-between gap-3 sm:mt-2">
                  <span className="inline-flex items-center gap-1 text-[10px] font-black uppercase tracking-wider text-white drop-shadow sm:text-xs">
                  ...
                  <Link
                    ...
                    className="inline-flex items-center gap-1.5 rounded-full bg-linear-to-r from-pink-500 to-orange-500 px-3 py-1.5 text-[10px] font-black text-white shadow-md transition-all hover:scale-105 sm:gap-2 sm:px-5 sm:py-2 sm:text-xs"
                  >
